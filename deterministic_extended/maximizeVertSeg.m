...
generations = 1500;%modify number of generations - 1000
parents = 15;%modify number of parents. Should be about 1/7 of lightPopSize. 15
...
[output,statistics, Gm] = isres('vani_deterministic_extended', 'max', [Lb; Ub], PopSize,generations,parents, 0.45, 1);

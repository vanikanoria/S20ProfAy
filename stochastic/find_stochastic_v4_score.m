function f = find_stochastic_v4_score(x)
...
%  5) Go to the next parameter set if the current one did not produce oscillations or did not satisfy the mutant conditions
    ...
    mh1_wt=vani_stochastic_v4(param_set_wt(k,1,:));
    if length(mh1_wt)~=timesteps
    %vani_stochastic_v4 return mh1=0 when the model is
    ...
    % ---- Delta mutant ----
    mh1_delta = vani_stochastic_v4(param_set_wt(k,2,:));
    ...
    % ---- Her1 mutant ----
    mh1_h1 = vani_stochastic_v4(param_set_wt(k,3,:));
    ...
    mh1_h7 = vani_stochastic_v4(param_set_wt(k,4,:));
    ...
    mh1_h6 = vani_stochastic_v4(param_set_wt(k,5,:));
    ...
    mh1_h76 = vani_stochastic_v4(param_set_wt(k,6,:));
